...
- Infer affected scenarios from the change, then use `browser-harness` in a dedicated work window to exercise them and the nearest plausible regression path.
