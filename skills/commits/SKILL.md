...
- When invoked directly, do not edit files, rewrite history, or push; wrapper skills may add subsequent push or PR actions. Report created commits and anything left uncommitted.
