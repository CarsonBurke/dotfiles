---
name: "openai-docs"
description: "Official OpenAI product and API documentation guidance with citations, current model selection, model upgrade guidance, and prompt-upgrade guidance; prioritize OpenAI docs MCP tools, use bundled references only as helper context, and restrict any fallback browsing to official OpenAI domains."
---
